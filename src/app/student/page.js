...
export default function StudentVault() {
  ...
  useEffect(() => {
    async function loadStudentCerts() {
      ...
      // Match certificates belonging to this student by email or username
      ...
      // Fallback demo certificate if nothing has been issued yet for this student
    ...
    <div className="min-h-screen py-10 px-4 max-w-5xl mx-auto space-y-6">
      ...
      {certs.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          {/* Certificate Detail & Selective Share Panel */}
          {selectedCert && (
            <div className="md:col-span-2 bg-[#0c1322] border border-slate-800 rounded-2xl p-6 space-y-6">
              ...
              <div className="flex gap-3 pt-2">
                <button
                  ...
                  className="flex-1 py-3 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 disabled:opacity-40 text-white font-bold text-xs rounded-xl transition cursor-pointer"
                >
